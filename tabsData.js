                ...
                groups: [
                    {
                        ...
                        tags: [
                            ...
                            { value: "solo", label: "單人" },
                            { value: "2girls", label: "2女" },
                            { value: "multiple girls", label: "多女" },
                ...
                groups: [
                    ...
                    },
                    {
                        ...
                        tags: [
                            ...
                            { value: "finger gun", label: "手指槍" },
                            { value: "pointing", label: "指著" },
                            { value: "arms behind back", label: "手背在身後" },
                            { value: "hands in pockets", label: "手插口袋" },
                            { value: "cat pose", label: "貓爪手勢" }
                        ]
                    },
                    {
                        name: "觸碰與遮擋",
                        tags: [
                            ...
                            { value: "hand on own chin", label: "手摸下巴" },
                            ...
                            { value: "shushing", label: "噓手勢" },
                            { value: "adjusting hair", label: "整理頭髮" },
                            { value: "hair tuck", label: "撩頭髮" },
                            { value: "adjusting clothes", label: "整理衣服" },
                            { value: "adjusting eyewear", label: "推眼鏡" },
                    ...
                    },
                    {
                        ...
                        tags: [
                            ...
                            { value: "back-to-back", label: "背對背" },
                            { value: "leaning on each other", label: "互相依靠" },
                            { value: "headpat", label: "摸頭" }
                        ]
                    },
                    {
                        name: "頭部與視線",
                ...
                groups: [
                    ...
                    },
                    {
                        ...
                        tags: [
                            ...
                            { value: "greatsword", label: "大劍" },
                            { value: "dagger", label: "短劍/匕首" },
                            { value: "knife", label: "刀" },
                            { value: "scythe", label: "鐮刀" },
                            { value: "bow", label: "弓" },
                            { value: "arrow", label: "箭" },
                            { value: "gun", label: "槍" },
                            { value: "handgun", label: "手槍" },
                            { value: "rifle", label: "步槍" },
                            { value: "spear", label: "長槍/矛" },
                            { value: "axe", label: "斧頭" },
                    ...
                    },
                    {
                        ...
                        tags: [
                            ...
                            { value: "transparent umbrella", label: "透明傘" }
                        ]
                    },
                    {
                        name: "樂器",
                ...
                groups: [
                    {
                        name: "視角與構圖",
                        tags: [
                            { value: "cowboy shot", label: "七分身(膝蓋以上)" },
                    ...
                    },
                    {
                        ...
                        tags: [
                            ...
                            { value: "bokeh", label: "背景模糊(散景)" },
                            { value: "motion blur", label: "動態模糊" },
                            { value: "chromatic aberration", label: "色差/故障風" },
                            { value: "vignetting", label: "暈影(暗角)" },
                            { value: "sharp focus", label: "清晰對焦" },
                    ...
                    },
                    {
                        ...
                        tags: [
                            ...
                            { value: "backlighting", label: "背光" },
                            { value: "rim lighting", label: "輪廓光/邊緣光" },
                            { value: "volumetric lighting", label: "體積光/丁達爾效應" },
                            { value: "crepuscular rays", label: "神光/耶穌光" },
                            { value: "god rays", label: "聖光" },
                            { value: "soft lighting", label: "柔光" },
                            { value: "hard lighting", label: "強光/硬光" },
                            { value: "dimly lit", label: "昏暗" },
                            { value: "glowing", label: "發光" },
                            { value: "bioluminescence", label: "生物發光" },
                            { value: "neon lights", label: "霓虹燈" },
                            { value: "shadow", label: "陰影" },
                            { value: "silhouette", label: "剪影" },
                            { value: "ray tracing", label: "光線追蹤" }
                        ]
                    }
                ]
            },
                ...
                groups: [
                    {
                        ...
                        tags: [
                            ...
                            { value: "incredibly absurdres", label: "極致解析度" }
                        ]
                    },
                    {
                        name: "攝影風格",
                        tags: [
                            ...
                            { value: "photorealistic", label: "照片級真實" },
                            { value: "raw photo", label: "原始照片" },
                            { value: "photo", label: "攝影照" },
                            { value: "fujifilm", label: "富士底片風" },
                            { value: "film grain", label: "底片顆粒" }
                        ]
                    },
                    {
                        name: "藝術風格",
                        tags: [
                            { value: "anime style", label: "動漫風格" },
                            { value: "illustration", label: "插畫" },
                            { value: "game cg", label: "遊戲CG" },
                            { value: "2d", label: "2D" },
                            { value: "3d", label: "3D" },
                            { value: "oil painting", label: "油畫" },
                            { value: "watercolor", label: "水彩" },
                            { value: "sketch", label: "素描" },
                            { value: "ink", label: "水墨/墨繪" },
                            { value: "line art", label: "線稿" },
                            { value: "cel shading", label: "賽璐珞上色" },
                            { value: "flat color", label: "平塗" },
                            { value: "thick impasto", label: "厚塗" },
                            { value: "impasto", label: "浮雕感" },
                            { value: "pixel art", label: "像素風" },
                            { value: "cyberpunk", label: "賽博龐克" },
                            { value: "steampunk", label: "蒸氣龐克" },
                            { value: "gothic", label: "哥德風" },
                            { value: "retro", label: "復古風" },
                            { value: "1980s (style)", label: "80年代風" }
                        ]
                    },
                    {
                        name: "色調",
                        tags: [
                            { value: "monochrome", label: "單色/黑白" },
                            { value: "greyscale", label: "灰階" },
                            { value: "sepia", label: "懷舊褐" },
